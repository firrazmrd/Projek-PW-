            ...
            <?php else: ?>
                ...
                <?php foreach ($articles as $a): ?>
                    <tr>
                        ...
                        <td>
                            <?php if ($a['image']): ?>
                                <img src="../<?= $a['image'] ?>" width="90" height="60" style="border-radius:8px;object-fit:cover;">
                            <?php else: ?>
                        ...
                        <td>
                            ...
                            <a href="read_single.php?slug=<?= urlencode($a['slug']) ?>" class="btn-view" target="_blank">Lihat</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            <?php endif; ?>

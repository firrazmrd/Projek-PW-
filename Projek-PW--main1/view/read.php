    ...
    <nav class="mt-4">
        <ul class="pagination justify-content-center">
            ...
            <li class="page-item <?= $page <= 1 ? 'disabled' : '' ?>">
                <a class="page-link btn-success text-white" href="?page=<?= $page - 1 ?>&q=<?= urlencode($search) ?>">Prev</a>
            </li>

            <?php for ($i = 1; $i <= $totalPages; $i++): ?>
                <li class="page-item <?= $i == $page ? 'active' : '' ?>">
                    <a class="page-link btn-success text-white" href="?page=<?= $i ?>&q=<?= urlencode($search) ?>"><?= $i ?></a>
                </li>
            <?php endfor; ?>

            <li class="page-item <?= $page >= $totalPages ? 'disabled' : '' ?>">
                <a class="page-link btn-success text-white" href="?page=<?= $page + 1 ?>&q=<?= urlencode($search) ?>">Next</a>
            </li>
